...
public class AnropsBehorighetsInfoType {
    ...
    protected List<se.skltp.tak.vagvalsinfo.wsdl.v2.FilterInfoType> filterInfo;
     ...
     * {@link se.skltp.tak.vagvalsinfo.wsdl.v2.FilterInfoType }
     * 
     * 
     */
    public List<se.skltp.tak.vagvalsinfo.wsdl.v2.FilterInfoType> getFilterInfo() {
        if (filterInfo == null) {
