...
public class TjanstekomponentInfoType {
    ...
    protected List<se.skltp.tak.vagvalsinfo.wsdl.v2.AnropsAdressInfoType> anropsAdressInfo;
    @XmlElement(nillable = true)
     ...
     * {@link se.skltp.tak.vagvalsinfo.wsdl.v2.AnropsAdressInfoType }
     * 
     * 
     */
    public List<se.skltp.tak.vagvalsinfo.wsdl.v2.AnropsAdressInfoType> getAnropsAdressInfo() {
