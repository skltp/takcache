...
public class HamtaAllaVirtualiseringarResponseType {
    ...
    protected List<se.skltp.tak.vagvalsinfo.wsdl.v2.VirtualiseringsInfoType> virtualiseringsInfo;
     ...
     * {@link se.skltp.tak.vagvalsinfo.wsdl.v2.VirtualiseringsInfoType }
     * 
     * 
     */
    public List<se.skltp.tak.vagvalsinfo.wsdl.v2.VirtualiseringsInfoType> getVirtualiseringsInfo() {
