...
public class TakServiceImpl implements TakService {
  ...
  public TakServiceImpl(@Value("${takcache.endpoint.address:null}") String endpointAddressTjanstekatalog,
      @Value("${takcache.header.user.agent:SKLTP VP/3.1}") String userAgentHeader) {
